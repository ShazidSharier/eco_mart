        ...
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarDashboards">
                    <ul class="slide-menu">
                        <li class="nav-item"><a href="" class="nav-link slide-item" data-key="t-analytics"> Category </a></li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarDashboards">
                    <ul class="slide-menu">
                        <li class="nav-item"><a href="" class="nav-link" data-key="t-analytics">All Order </a></li>
                    </ul>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarDashboards">
                    <ul class="slide-menu">
                        <li class="nav-item"><a href="" class="nav-link" data-key="t-analytics">Courier List</a></li>
                    </ul>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarDashboards">
                    <ul class="slide-menu">
                        <li class="nav-item"><a href="" class="nav-link" data-key="t-analytics">User List</a></li>
                        <li class="nav-item"><a href="" class="nav-link" data-key="t-analytics">Add User</a></li>
                    </ul>
                </div>
            </li>
            <!-- end Dashboard Menu -->
